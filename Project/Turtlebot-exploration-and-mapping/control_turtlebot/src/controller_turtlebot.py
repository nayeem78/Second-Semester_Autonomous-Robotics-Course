...
from control_turtlebot.srv import StartGoToGoal, StartGoToGoalResponse, StartFindingPath, StartFindingPathResponse, StartFindingPathRequest
#Numpy
import numpy as np
...
class Controller(object):
	...
	def __init__(self):
		...
		self.serv_ = rospy.Service('/controller_turtlebot/ready_to_go', 
                                  StartGoToGoal, 
		...
		rospy.wait_for_service('/controller_turtlebot/start_finding_path')
		try:
			self.find_path_to_goal_serv_ = rospy.ServiceProxy('/controller_turtlebot/start_finding_path', StartFindingPath)
